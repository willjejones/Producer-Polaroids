...
<div class="row">
    <div class="column">
        <img src="{{ site.url }}/public/assets/generative_art/cliff1.png" style="width: 100%" alt="Genetic Art">
    </div>
    <div class="column">
...
<img style="max-width: 50%;" src="{{ site.url }}/public/assets/generative_art/cliff2.png" style="width: 100%" alt="Genetic Art">
