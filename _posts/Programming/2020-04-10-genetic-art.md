...
So question in the context of my artwork was essentially: can I find a way of reproducing some given picture or art, with an initially random population of candidate images that "breed" for a number of generations until I start to see members of newer populations that look like the source image?
